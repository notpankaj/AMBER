...
const LoginScreen = ({ navigation }) => {
  ...
  //   appleFirstname = result.fullName.givenName;
  //   appleSecondName = result.fullName.familyName;
  //   appleSocialId = result.authorizationCode;
  //   doSocialLogin(result, "apple");
  // };
  ...
  const doSocialLogin = async (data, mediaType) => {
    ...
    // if (mediaType === "apple") {
    //   const payload = {
    //     socialLoginId: appleSocialId,
    //     platform: "apple",
    //     firstName: appleFirstname,
    //     lastName: appleSecondName,
    //     gender: "male",
    //     deviceToken: fcmToken,
    //   };
    //   hitSocialLogin(payload);

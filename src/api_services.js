...
export const api_getNotification = async (payload) => {
  const { token, userID } = payload;
  const uri = `${BASE_URL}/notifications/byUserId/${userID}`;
  console.log(payload, uri, "lll");
  const response = await fetch(uri, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
...
//Seen Notification
export const api_SeenNotification = async (payload) => {
  const { token, notiId } = payload;
  const uri = `${BASE_URL}/notifications/seen/${notiId}`;
  const response = await fetch(uri, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
...
export const api_inAppPurchase = async (payload) => {
  ...
  const BODY_DATA = {
    ...
    transactionReceipt: {
      ...
      purchaseTime: transactionReceipt?.purchaseTime,
      purchaseState: transactionReceipt?.purchaseState,
      purchaseToken: transactionReceipt?.purchaseToken,
      quantity: transactionReceipt?.quantity,
      acknowledged: transactionReceipt?.acknowledged,
    },
...
//Send Attachments
export const api_sendChatAttachments = async (payload) => {
  const { token, data } = payload;

  console.log(data, "data");
  const uri = `${BASE_URL}/attachments/sendAttachment`;
  const response = await fetch(uri, {
    method: "POST",
    headers: {
      "x-access-token": token,
...
export const api_contactUs = async (payload) => {
  let { token, data } = payload;
  const uri = `${BASE_URL}/contactus/create`;
  const response = await fetch(uri, {
    method: "POST",
    headers: {
      "x-access-token": token,
...
export const api_usesNotiSettings = async (payload) => {
  let { token, data } = payload;
  const uri = `${BASE_URL}/users/settings`;
  const response = await fetch(uri, {
    method: "POST",
    headers: {
      "x-access-token": token,
